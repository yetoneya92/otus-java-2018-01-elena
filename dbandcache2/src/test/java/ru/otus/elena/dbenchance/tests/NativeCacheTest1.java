...
public class NativeCacheTest1 {
    ...
    public static void main(String[] args) {
        ...
        Compote comoc=(Compote)cache.get(2, Compote.class);
        System.out.println("FROM CACHE="+comoc);       
        comoc=(Compote)cache.get(2, Compote.class);
        System.out.println("FROM CACHE="+comoc);
        service.deleteAllTables();
        service.shutDown();
    }
