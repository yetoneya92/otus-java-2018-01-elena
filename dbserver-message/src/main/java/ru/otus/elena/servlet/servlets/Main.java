...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        context.addServlet(UserActionServlet.class,"/useraction");
        context.addServlet(UserReadServlet.class,"/userread");
        context.addServlet(TableServlet.class,"/table");
        context.addServlet(TestServlet.class,"/test");
        context.addServlet(UserNameServlet.class,"/username");
        context.addServlet(MessageServlet.class,"/message");
        context.addServlet(MessageStoreServlet.class,"/store");
