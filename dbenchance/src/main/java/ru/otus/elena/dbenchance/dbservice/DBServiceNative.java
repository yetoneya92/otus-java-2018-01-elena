...
import ru.otus.elena.dbenchance.executors.SimpleExecutor;
import ru.otus.elena.dbenchance.executors.TExecutor;
import ru.otus.elena.dbenchance.executors.TransactionExecutor;
...
public class DBServiceNative implements DBService{
    ...
    public <T extends DataSet> T loadById(long id, Class<T> clazz) {
        try {
            ...
            T data = exec.execQuery(command, result -> {
