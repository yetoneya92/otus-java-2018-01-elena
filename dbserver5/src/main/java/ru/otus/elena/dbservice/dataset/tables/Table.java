...
import ru.otus.elena.dbservice.dataset.base.DataSet;
    ...
    baby {
      @Override
      public <T extends DataSet> Class<T> getClazz(){return (Class<T>) Baby.class;}
    }, 
    compote {
    @Override
    public <T extends DataSet> Class<T> getClazz(){return (Class<T>) Compote.class;}
    }, 
    fruit {
    @Override
    public <T extends DataSet> Class<T> getClazz(){return (Class<T>) Fruit.class;}
    }, 
