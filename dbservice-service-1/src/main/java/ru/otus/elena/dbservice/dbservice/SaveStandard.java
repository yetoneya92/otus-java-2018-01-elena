...
public class SaveStandard {
    ...
    private final SaveBaby saveBaby;
    private final SaveCompote saveCompote;
    private final ServiceTable serviceTable;

    @Autowired
    public SaveStandard(SaveBaby saveBaby,SaveCompote saveCompote,ServiceTable serviceTable){
        this.saveBaby=saveBaby;
        this.saveCompote=saveCompote;
